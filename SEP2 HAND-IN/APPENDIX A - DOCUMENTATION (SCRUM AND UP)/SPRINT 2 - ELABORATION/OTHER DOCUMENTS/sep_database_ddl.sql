...
ALTER TABLE extraInItemInOrder
    ...
    ADD CONSTRAINT itemInOrderFK FOREIGN KEY (order_id, item_id) REFERENCES itemInOrder (order_id, item_id) ON DELETE CASCADE;
...
INSERT INTO item (name, type, price, description) VALUES ('Coffee', 'coffee', 20, ':)'), ('Tea', 'tea', 7, 'lovely herbal tea');
INSERT INTO extra (name) VALUES ('caramel syrup'), ('honey');
